...
const getters = {
  whatStatement: state => state.whatStatement,
  whats: state => state.whats,
  whatHowId: state => state.whatHowId,
  whatId: state => state.whatId
}

const actions = {
  getWhats ({ commit, state, rootState }, payload) {
